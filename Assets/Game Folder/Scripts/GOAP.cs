...
public class GOAP : MonoBehaviour {
	...
	ActionSequence.allPreconditions isEnemyClose()
    {
		...
		if (enemies.transform.childCount == 0) {return ActionSequence.allPreconditions.noEnemy; }
		...
		if (closest < enemyDistanceLimit) { return ActionSequence.allPreconditions.enemyClose;}
    ...
    private float CalculateLowHealthCondition(ActionSequence currentSequence)
    {
    ...
    private float CalculateLowAmmoCondition(ActionSequence currentSequence)
    {
    ...
    private float CalculateEnemyFarCondition(ActionSequence currentSequence)
    {
